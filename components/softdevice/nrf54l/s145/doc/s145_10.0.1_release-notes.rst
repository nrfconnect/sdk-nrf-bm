...
This is a production release that contains minor, backward compatible changes to the s145_10.0.0.

Notes:

- This SoftDevice is binary compatible with the s145_10.0.0 and memory requirements have not changed.
...
* SoftDevice base address:
  ...
  * nRF54L05: 0x05a800 (``s145_nrf54l05_10.0.1_softdevice.hex``).

  * nRF54L10: 0x0da800 (``s145_nrf54l10_10.0.1_softdevice.hex``).

  * nRF54L15: 0x15a800 (``s145_nrf54l15_10.0.1_softdevice.hex``).
