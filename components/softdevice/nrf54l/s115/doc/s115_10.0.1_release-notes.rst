...
This is a production release that contains minor, backward compatible changes to the s115_10.0.0.

Notes:

- This SoftDevice is binary compatible with the s115_10.0.0 and memory requirements have not changed.
  Applications are therefore not required to be recompiled.
- The release notes list changes since s115_10.0.0.
...
* SoftDevice base address:
  ...
  * nRF54L05: 0x063800 (``s115_nrf54l05_10.0.1_softdevice.hex``).

  * nRF54L10: 0x0e3800 (``s115_nrf54l10_10.0.1_softdevice.hex``).

  * nRF54L15: 0x163800 (``s115_nrf54l15_10.0.1_softdevice.hex``).

* The Firmware ID of this SoftDevice is 0x310D.
