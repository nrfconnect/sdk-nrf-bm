...
* SoftDevice base address:
  ...
  * nRF54L05: 0x063800 (``s115_nrf54l05_10.0.0-1.prototype_softdevice.hex``).

  * nRF54L10: 0x0e3800 (``s115_nrf54l10_10.0.0-1.prototype_softdevice.hex``).

  * nRF54L15: 0x163800 (``s115_nrf54l15_10.0.0-1.prototype_softdevice.hex``).

* The Firmware ID of this SoftDevice is 0x308C.


See the changelog of the `SoftDevice Controller`_ and `MPSL`_ for more details about changes in the controller.

.. _SoftDevice Controller: https://docs.nordicsemi.com/bundle/ncs-latest/page/nrfxlib/softdevice_controller/CHANGELOG.html
.. _MPSL: https://docs.nordicsemi.com/bundle/ncs-latest/page/nrfxlib/mpsl/CHANGELOG.html
