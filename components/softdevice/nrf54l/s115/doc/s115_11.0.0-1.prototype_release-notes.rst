...
* SoftDevice base address:
  ...
  * nRF54L05: 0x063800 (``s115_nrf54l05_11.0.0-1.prototype_softdevice.hex``).

  * nRF54L10: 0x0e3800 (``s115_nrf54l10_11.0.0-1.prototype_softdevice.hex``).

  * nRF54L15: 0x163800 (``s115_nrf54l15_11.0.0-1.prototype_softdevice.hex``).

* The Firmware ID of this SoftDevice is 0x302C.

This version of the SoftDevice includes the SoftDevice Controller and Multiprotocol Service Layer (MPSL) libraries from nRF Connect SDK.
See the changelog of the `SoftDevice Controller <https://docs.nordicsemi.com/bundle/ncs-latest/page/nrfxlib/softdevice_controller/CHANGELOG.html>`__
and `MPSL <https://docs.nordicsemi.com/bundle/ncs-latest/page/nrfxlib/mpsl/CHANGELOG.html>`__ for more details about changes in these components.
