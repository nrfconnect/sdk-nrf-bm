...
* All samples that is compatible with the new board targets PCA10188 (`nRF54LV10 DK`_), PCA10184 (`nRF54LM20 DK`_), PCA10214 (nRF54LS05 DK) have been updated to support these boards.
