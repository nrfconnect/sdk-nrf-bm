...
.. tabs::
   ...
   .. group-tab:: Pre-packaged SDK & Toolchain
      ...
      #. When prompted to **Select an SDK version (or enter the branch, tag or commit SHA) to install...**, click :guilabel:`v2.0.1` marked on the right by the label :guilabel:`Pre-packaged SDKs & Toolchains`.
   ...
   .. group-tab:: GitHub
         ...
         #. Install the SDK.
            ...
            #. When prompted to **Select an SDK version (or enter the branch, tag or commit SHA) to install...**, click :guilabel:`v2.0.1` marked on the right by the label :guilabel:`GitHub`.
