...
The completion of the operation is reported by the :c:enumerator:`BM_STORAGE_EVT_WRITE_RESULT` event.
...
The completion of the operation is reported by the :c:enumerator:`BM_STORAGE_EVT_ERASE_RESULT` event.
...
* :c:enumerator:`BM_STORAGE_EVT_WRITE_RESULT` – Write operation completed.
* :c:enumerator:`BM_STORAGE_EVT_ERASE_RESULT` – Erase operation completed.
