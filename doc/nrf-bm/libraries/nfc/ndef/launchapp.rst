...
The Launch App library provides a way to create NFC messages capable of launching Android or iOS applications.

Overview
********

A Launch App message contains two records: URI record and Android Launch App record.
