...
The library sits on top of the nrfx SPIM driver.
Scheduling is non-blocking, work is added to the queue and the call returns immediately, with completion reported through an optional end callback.
