...
Declare the service instance using the :c:macro:`BLE_BAS_CLIENT_DEF` macro, specifying the name of the instance.
Call the :c:func:`ble_bas_client_init` function to initialize the service.
