...
Declare the service instance using the :c:macro:`BLE_NUS_CLIENT_DEF` macro, specifying the name of the instance.
Call the :c:func:`ble_nus_client_init` function to initialize the service.
