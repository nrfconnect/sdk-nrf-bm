...
* The :kconfig:option:`CONFIG_BLE_CGMS_BLE_OBSERVER_PRIO` Kconfig option to set the observer priority of the CGMS instance.
* The :kconfig:option:`CONFIG_BLE_CGMS_DB_RECORDS_MAX` Kconfig option to set the maximum number of records that can be stored in the database.
