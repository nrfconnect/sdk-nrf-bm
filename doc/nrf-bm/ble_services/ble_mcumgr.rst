...
Bluetooth: MCU manager Service (MCUmgr)
#######################################
...
The MCU manager service allows remote management of the device over Bluetooth.
This is based on the Simple Management Protocol (SMP) provided by :ref:`MCUmgr`, an open source project that provides a management subsystem that is portable across multiple real-time operating systems.
