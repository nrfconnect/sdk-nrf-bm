...
_NRF_BM_BASE = Path(__file__).parents[2]
"""nRF BM Repository root"""

_MANIFEST = Manifest.from_file(_NRF_BM_BASE / "west.yml")
"""Manifest instance"""

ALL_DOCSETS = {
    "nrf-bm": ("nRF Connect SDK Bare Metal", "index", "manifest"),
...
def get_intersphinx_mapping(docset: str) -> tuple[str, str] | None:  # pylint: disable=unsubscriptable-object
