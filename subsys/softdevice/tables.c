...
#if defined(BLE_GAP_EVT_RSSI_CHANGED)
	case BLE_GAP_EVT_RSSI_CHANGED:
		return "BLE_GAP_EVT_RSSI_CHANGED";
#endif
#if defined(BLE_GAP_EVT_ADV_REPORT)
	case BLE_GAP_EVT_ADV_REPORT:
		return "BLE_GAP_EVT_ADV_REPORT";
#endif
#if defined(BLE_GAP_EVT_CONN_PARAM_UPDATE_REQUEST)
	case BLE_GAP_EVT_CONN_PARAM_UPDATE_REQUEST:
		return "BLE_GAP_EVT_CONN_PARAM_UPDATE_REQUEST";
#endif
#if defined(BLE_GAP_EVT_SEC_REQUEST)
...
#ifdef SOFTDEVICE_DATA_LENGTH_UPDATE
	case BLE_GAP_EVT_DATA_LENGTH_UPDATE_REQUEST:
		return "BLE_GAP_EVT_DATA_LENGTH_UPDATE_REQUEST";
#endif
#if defined(BLE_GAP_EVT_DATA_LENGTH_UPDATE)
	case BLE_GAP_EVT_DATA_LENGTH_UPDATE:
		return "BLE_GAP_EVT_DATA_LENGTH_UPDATE";
#endif
#if defined(BLE_GAP_EVT_QOS_CHANNEL_SURVEY_REPORT)
