...
LOG_MODULE_REGISTER(ble_bms, CONFIG_CONN_STATE_LOG_LEVEL);

/* The number of flag collections in struct ble_conn_state_flag_collections besides user flags. */
#define CONN_STATE_DEFAULT_FLAG_COLLECTION_COUNT 6
