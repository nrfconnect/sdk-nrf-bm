...
#warning "Using alternative soc.c file in BM"
...
/*
Then you can use Kconfigs to configure things, e.g.
CONFIG_SOC_NORDIC_NRF54L_LFXO_SOMETHING_A
CONFIG_SOC_NORDIC_NRF54L_LFXO_CAP_1_0PF
CONFIG_SOC_NORDIC_NRF54L_LFXO_CAP_0_5PF
for this dummy sample PR
*/
...
//this needs to change to soc (early?) hook
