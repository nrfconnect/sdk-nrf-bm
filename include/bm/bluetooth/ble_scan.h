 ...
 * the need of setting the whitelist. The library can also be configured to automatically connect
 ...
 *
 * @note @ref BLE_SCAN_EVT_WHITELIST_REQUEST cannot be ignored if whitelist is used.
 */
...
#define BLE_SCAN_INIT_SCAN_PARAM_DEFAULT                                                           \
{                                                                                                  \
	.active = 1,                                                                               \
	.interval = CONFG_BLE_SCAN_SCAN_INTERVAL,                                                  \
...
#define BLE_SCAN_INIT_CONN_PARAM_DEFAULT                                                           \
{                                                                                                  \
	...
	.slave_latency = (uint16_t)CONFIG_BLE_SCAN_SLAVE_LATENCY,                                  \
}
...
/**
 * @brief Check if the whitelist is used.
 *
