 ...
 */
#define BLE_NUS_CLIENT_MAX_DATA_LEN_CALC(mtu_size) ((mtu_size) - OPCODE_LENGTH - HANDLE_LENGTH)
 ...
 *          of this service to receive events.
 */
...
/**
 * @brief     Function for initializing the Nordic UART client service.
 *
 * @details   This function registers with the Database Discovery library
 *            for the NUS.
 *
 ...
 *                        returned by the Database Discovery library API
...
/**
 * @brief Function for handling events from the Database Discovery library.
 *
 * @details This function handles an event from the Database Discovery library, and determines
 ...
 *
 * @param[in] ble_nus_client Pointer to the NUS client structure.
 * @param[in] evt       Pointer to the event received from the Database Discovery library.
 */
...
/**
 * @brief Function for assigning handles to this instance of the service.
 *
 * @details Call this function when a link has been established with a peer to
 *          associate the link to this instance of the service. This makes it
 *          possible to handle several links and associate each link to a particular
 *          instance of this service. The connection handle and attribute handles are
