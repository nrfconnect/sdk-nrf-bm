 ...
 */
#ifndef NRFBM_SETTINGS_BLE_RMEM_H__
#define NRFBM_SETTINGS_BLE_RMEM_H__
...
#define BLE_RMEM_MAX_NAME_SIZE 16

/**
 * @brief Retrieve the variable that holds the desired device advertising name.
 *
 * @param[in] ctx Runtime context of retention memory.
...
#endif /* NRFBM_SETTINGS_BLE_RMEM_H__ */
