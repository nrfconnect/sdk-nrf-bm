...
/**
 * @brief Access the ECC public key used for LESC DH key generation.
 *
...
/**
 * @brief Respond to a DH key requests.
 *
 ...
 *
 * @param[in] evt  Event received from the BLE stack.
 */
void nrf_ble_lesc_on_ble_evt(ble_evt_t const *evt);
