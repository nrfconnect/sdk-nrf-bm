 ...
 * @param[out] racp_val Pointer to decoded Record Access Control Point write.
 *                      @note This does not do a data copy. It assumes the data pointed to by
 *                      @c data is persistent until no longer needed.
 */
 ...
 *
 * @param[in] racp_val Pointer to Record Access Control Point to encode.
 * @param[out] data Pointer to where encoded data is written.
 *
