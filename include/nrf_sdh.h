...
#define _NRF_SDH_OBSERVER_PRIO_HIGH_HIGH 1
#define _NRF_SDH_OBSERVER_PRIO_USER_USER 1
#define _NRF_SDH_OBSERVER_PRIO_USER_LOW_USER_LOW 1
#define _NRF_SDH_OBSERVER_PRIO_LOWEST_LOWEST 1
...
#define PRIO_LEVEL_IS_VALID(level)                                                                 \
	COND_CODE_1(_NRF_SDH_OBSERVER_PRIO_HIGHEST_##level, (),                                    \
	(COND_CODE_1(_NRF_SDH_OBSERVER_PRIO_HIGH_##level, (),                                      \
	(COND_CODE_1(_NRF_SDH_OBSERVER_PRIO_USER_##level, (),                                      \
	(COND_CODE_1(_NRF_SDH_OBSERVER_PRIO_USER_LOW_##level, (),                                  \
	(COND_CODE_1(_NRF_SDH_OBSERVER_PRIO_LOWEST_##level, (),                                    \
...
#define PRIO_LEVEL_ORD(level)                                                                      \
	COND_CODE_1(_NRF_SDH_OBSERVER_PRIO_HIGHEST_##level, (0),                                   \
	(COND_CODE_1(_NRF_SDH_OBSERVER_PRIO_HIGH_##level, (1),                                     \
	(COND_CODE_1(_NRF_SDH_OBSERVER_PRIO_USER_##level, (2),                                     \
	(COND_CODE_1(_NRF_SDH_OBSERVER_PRIO_USER_LOW_##level, (3),                                 \
	(COND_CODE_1(_NRF_SDH_OBSERVER_PRIO_LOWEST_##level, (4),                                   \
	(BUILD_ASSERT(0, "Invalid priority level")))))))))))
