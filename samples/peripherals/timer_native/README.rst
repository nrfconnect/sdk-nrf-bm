...
The Timer sample demonstrates the use of zephyr's k_timer in single-shot and
periodic mode.
...
The timer in single-shot mode is used to sequence a series of actions
(printing ``Hello``, ``world!``, and ``bye!``), while the timer in
periodic mode provides a visual indication of ongoing activity.
