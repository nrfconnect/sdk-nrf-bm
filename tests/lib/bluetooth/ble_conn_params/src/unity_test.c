...
void test_ble_evt_exchange_mtu_rsp(void)
{
	...
	TEST_ASSERT_EQUAL(BLE_CONN_PARAMS_EVT_ATT_MTU_UPDATED, app_evt.id);
...
void test_ble_evt_conn_param_update_accepted(void)
{
	...
	TEST_ASSERT_EQUAL(BLE_CONN_PARAMS_EVT_UPDATED, app_evt.id);
	TEST_ASSERT_EQUAL(CONN_HANDLE, app_evt.conn_handle);
...
void test_ble_evt_conn_param_update_busy(void)
{
	...
	TEST_ASSERT_EQUAL(BLE_CONN_PARAMS_EVT_REJECTED, app_evt.id);
	TEST_ASSERT_EQUAL(CONN_HANDLE, app_evt.conn_handle);
}
...
void test_ble_evt_data_length_update(void)
{
	...
	TEST_ASSERT_EQUAL(BLE_CONN_PARAMS_EVT_DATA_LENGTH_UPDATED, app_evt.id);
	TEST_ASSERT_EQUAL(CONN_HANDLE, app_evt.conn_handle);
...
void test_ble_evt_phy_update(void)
{
	...
	TEST_ASSERT_EQUAL(BLE_CONN_PARAMS_EVT_RADIO_PHY_MODE_UPDATED, app_evt.id);
	TEST_ASSERT_EQUAL(CONN_HANDLE, app_evt.conn_handle);
	...
	TEST_ASSERT_EQUAL(4, app_evt.phy_update_evt.status);
}
