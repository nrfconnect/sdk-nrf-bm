...
static uint8_t                            m_arbitrary_sys_attr_data[SYS_ATTR_LEN_3_CCCDS] = {7,7,96,43,3,86,8,7,58,3,8,6,74,48,7,8}; // 3 CCCDs
static uint8_t                            m_arbitrary_array[50];
static uint8_t                            m_arbitrary_array2[50];
static pm_peer_data_local_gatt_db_t     * m_arbitrary_local_gatt_data = (pm_peer_data_local_gatt_db_t *)m_arbitrary_array;
static pm_peer_data_local_gatt_db_t     * m_arbitrary_local_gatt_data_ref = (pm_peer_data_local_gatt_db_t *)m_arbitrary_array2;
...
void setUp(void)
{
    ...
    memcpy(m_arbitrary_local_gatt_data->data, m_arbitrary_sys_attr_data, m_arbitrary_sys_attr_len); //lint !e419

    m_arbitrary_local_gatt_data_ref->len = m_arbitrary_sys_attr_len;
    m_arbitrary_local_gatt_data_ref->flags = SYS_ATTR_BOTH;
    memcpy(m_arbitrary_local_gatt_data_ref->data, m_arbitrary_sys_attr_data, m_arbitrary_sys_attr_len); //lint !e419
    (void) gscm_init();
}
...
void test_gscm_local_db_cache_update(void)
{
    ...
    pdb_write_buf_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, 1, &returned_peer_data, NRF_ERROR_BUSY);
    ...
    im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle, m_arbitrary_peer_id);
    pdb_write_buf_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, 1, &returned_peer_data, NRF_SUCCESS);
    pdb_write_buf_get_IgnoreArg_p_peer_data();
    pdb_write_buf_get_ReturnThruPtr_p_peer_data(&returned_peer_data);
    sd_ble_gatts_sys_attr_get_ExpectWithArrayAndReturn(m_arbitrary_conn_handle, &m_arbitrary_local_gatt_data->data[0], 0, &m_arbitrary_local_gatt_data->len, 1, (BLE_GATTS_SYS_ATTR_FLAG_SYS_SRVCS | BLE_GATTS_SYS_ATTR_FLAG_USR_SRVCS), NRF_ERROR_DATA_SIZE);
    pdb_write_buf_release_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, NRF_SUCCESS);
    pdb_write_buf_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, 2, &returned_peer_data, NRF_SUCCESS);
    pdb_write_buf_get_IgnoreArg_p_peer_data();
    pdb_write_buf_get_ReturnThruPtr_p_peer_data(&returned_peer_data);
    sd_ble_gatts_sys_attr_get_ExpectWithArrayAndReturn(m_arbitrary_conn_handle, &m_arbitrary_local_gatt_data->data[0], 0, &m_arbitrary_local_gatt_data->len, 1, (BLE_GATTS_SYS_ATTR_FLAG_SYS_SRVCS | BLE_GATTS_SYS_ATTR_FLAG_USR_SRVCS), NRF_ERROR_DATA_SIZE);
    pdb_write_buf_release_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, NRF_SUCCESS);
    pdb_write_buf_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, 3, &returned_peer_data, NRF_ERROR_BUSY);
    pdb_write_buf_get_IgnoreArg_p_peer_data();
    ...
    sd_ble_gatts_sys_attr_get_ExpectWithArrayAndReturn(m_arbitrary_conn_handle, &m_arbitrary_local_gatt_data->data[0], 0, &m_arbitrary_local_gatt_data->len, 1, (BLE_GATTS_SYS_ATTR_FLAG_SYS_SRVCS | BLE_GATTS_SYS_ATTR_FLAG_USR_SRVCS), NRF_ERROR_DATA_SIZE);
    pdb_write_buf_release_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, NRF_SUCCESS);
    pdb_write_buf_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, 2, &returned_peer_data, NRF_ERROR_INVALID_PARAM);
    pdb_write_buf_get_IgnoreArg_p_peer_data();
    ...
    pdb_write_buf_get_IgnoreArg_p_peer_data();
    pdb_write_buf_get_ReturnThruPtr_p_peer_data(&returned_peer_data);
    sd_ble_gatts_sys_attr_get_ExpectWithArrayAndReturn(m_arbitrary_conn_handle, &m_arbitrary_local_gatt_data->data[0], 0, &m_arbitrary_local_gatt_data->len, 1, (BLE_GATTS_SYS_ATTR_FLAG_SYS_SRVCS | BLE_GATTS_SYS_ATTR_FLAG_USR_SRVCS), NRF_SUCCESS);
    m_arbitrary_local_gatt_data->data[0]++; // to be different from reference
    pdb_peer_data_ptr_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, NULL, NRF_SUCCESS);
    pdb_peer_data_ptr_get_IgnoreArg_p_peer_data();
    pdb_peer_data_ptr_get_ReturnThruPtr_p_peer_data(&stored_peer_data);
    pdb_write_buf_store_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, m_arbitrary_peer_id, NRF_ERROR_STORAGE_FULL);
    ...
    pdb_write_buf_get_ReturnThruPtr_p_peer_data(&returned_peer_data);
    sd_ble_gatts_sys_attr_get_ExpectWithArrayAndReturn(m_arbitrary_conn_handle, &m_arbitrary_local_gatt_data->data[0], 0, &m_arbitrary_local_gatt_data->len, 1, (BLE_GATTS_SYS_ATTR_FLAG_SYS_SRVCS | BLE_GATTS_SYS_ATTR_FLAG_USR_SRVCS), NRF_SUCCESS);
    sd_ble_gatts_sys_attr_get_ReturnArrayThruPtr_p_sys_attr_data(m_arbitrary_sys_attr_data, m_arbitrary_sys_attr_len);
    sd_ble_gatts_sys_attr_get_ReturnThruPtr_p_len(((uint16_t*)&m_arbitrary_sys_attr_len));

    pdb_peer_data_ptr_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, NULL, NRF_ERROR_INVALID_PARAM);
    pdb_peer_data_ptr_get_IgnoreArg_p_peer_data();
    pdb_peer_data_ptr_get_ReturnThruPtr_p_peer_data(&stored_peer_data);
    ...
    pdb_write_buf_get_IgnoreArg_p_peer_data();
    pdb_write_buf_get_ReturnThruPtr_p_peer_data(&returned_peer_data);
    sd_ble_gatts_sys_attr_get_ExpectWithArrayAndReturn(m_arbitrary_conn_handle, &m_arbitrary_local_gatt_data->data[0], 0, &m_arbitrary_local_gatt_data->len, 1, (BLE_GATTS_SYS_ATTR_FLAG_SYS_SRVCS | BLE_GATTS_SYS_ATTR_FLAG_USR_SRVCS), NRF_ERROR_NOT_FOUND);
    pdb_write_buf_release_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, NRF_SUCCESS);
    ...
    pdb_write_buf_release_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, NRF_SUCCESS);
    pdb_write_buf_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, 3, &returned_peer_data, NRF_SUCCESS);
    pdb_write_buf_get_IgnoreArg_p_peer_data();
    pdb_write_buf_get_ReturnThruPtr_p_peer_data(&returned_peer_data);
    sd_ble_gatts_sys_attr_get_ExpectWithArrayAndReturn(m_arbitrary_conn_handle, &m_arbitrary_local_gatt_data->data[0], 0, &m_arbitrary_local_gatt_data->len, 1, (BLE_GATTS_SYS_ATTR_FLAG_SYS_SRVCS | BLE_GATTS_SYS_ATTR_FLAG_USR_SRVCS), NRF_SUCCESS);
    ...
    pdb_peer_data_ptr_get_IgnoreArg_p_peer_data();
    pdb_peer_data_ptr_get_ReturnThruPtr_p_peer_data(&stored_peer_data);
    pdb_write_buf_store_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, m_arbitrary_peer_id, NRF_SUCCESS);
    err_code = gscm_local_db_cache_update(m_arbitrary_conn_handle);
    TEST_ASSERT_EQUAL_UINT(NRF_SUCCESS, err_code);
    ...
    pdb_peer_data_ptr_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, NULL, NRF_ERROR_NOT_FOUND);
    pdb_peer_data_ptr_get_IgnoreArg_p_peer_data();
    pdb_peer_data_ptr_get_ReturnThruPtr_p_peer_data(&stored_peer_data);
    pdb_write_buf_store_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, m_arbitrary_peer_id, NRF_SUCCESS);
    ...
    err_code = gscm_local_db_cache_update(m_arbitrary_conn_handle);
    TEST_ASSERT_EQUAL_UINT(NRF_SUCCESS, err_code);
    TEST_ASSERT_EQUAL_UINT((BLE_GATTS_SYS_ATTR_FLAG_SYS_SRVCS | BLE_GATTS_SYS_ATTR_FLAG_USR_SRVCS), m_arbitrary_local_gatt_data->flags);
    TEST_ASSERT_EQUAL_UINT(m_arbitrary_sys_attr_len, m_arbitrary_local_gatt_data->len);
    TEST_ASSERT_EQUAL_UINT8_ARRAY(m_arbitrary_sys_attr_data, m_arbitrary_local_gatt_data->data, m_arbitrary_sys_attr_len);
...
void test_gscm_local_db_cache_apply(void)
{
    ...
    // Not bonded.
    im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle, PM_PEER_ID_INVALID);
    sd_ble_gatts_sys_attr_set_ExpectAndReturn(m_arbitrary_conn_handle, NULL, 0, (BLE_GATTS_SYS_ATTR_FLAG_SYS_SRVCS | BLE_GATTS_SYS_ATTR_FLAG_USR_SRVCS), NRF_SUCCESS);
    ...
    im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle, m_arbitrary_peer_id);
    pdb_peer_data_ptr_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, &returned_peer_data, NRF_ERROR_NOT_FOUND);
    pdb_peer_data_ptr_get_IgnoreArg_p_peer_data();
    sd_ble_gatts_sys_attr_set_ExpectAndReturn(m_arbitrary_conn_handle, NULL, 0, (BLE_GATTS_SYS_ATTR_FLAG_SYS_SRVCS | BLE_GATTS_SYS_ATTR_FLAG_USR_SRVCS), NRF_SUCCESS);
    ...
    im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle, m_arbitrary_peer_id);
    pdb_peer_data_ptr_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_GATT_LOCAL, &returned_peer_data, NRF_SUCCESS);
    pdb_peer_data_ptr_get_IgnoreArg_p_peer_data();
    pdb_peer_data_ptr_get_ReturnThruPtr_p_peer_data(&returned_peer_data);
    sd_ble_gatts_sys_attr_set_ExpectWithArrayAndReturn(m_arbitrary_conn_handle, p_local_db_data->data, p_local_db_data->len, p_local_db_data->len, p_local_db_data->flags, NRF_ERROR_INVALID_STATE);
    ...
    pdb_peer_data_ptr_get_IgnoreArg_p_peer_data();
    pdb_peer_data_ptr_get_ReturnThruPtr_p_peer_data(&returned_peer_data);
    sd_ble_gatts_sys_attr_set_ExpectWithArrayAndReturn(m_arbitrary_conn_handle, p_local_db_data->data, p_local_db_data->len,  p_local_db_data->len, p_local_db_data->flags, NRF_ERROR_BUSY);
    ...
    pdb_peer_data_ptr_get_IgnoreArg_p_peer_data();
    pdb_peer_data_ptr_get_ReturnThruPtr_p_peer_data(&returned_peer_data);
    sd_ble_gatts_sys_attr_set_ExpectWithArrayAndReturn(m_arbitrary_conn_handle, p_local_db_data->data, p_local_db_data->len,  p_local_db_data->len, p_local_db_data->flags, NRF_ERROR_NO_MEM);
    ...
    pdb_peer_data_ptr_get_IgnoreArg_p_peer_data();
    pdb_peer_data_ptr_get_ReturnThruPtr_p_peer_data(&returned_peer_data);
    sd_ble_gatts_sys_attr_set_ExpectWithArrayAndReturn(m_arbitrary_conn_handle, p_local_db_data->data, p_local_db_data->len,  p_local_db_data->len, p_local_db_data->flags, NRF_ERROR_INVALID_DATA);
    sd_ble_gatts_sys_attr_set_ExpectWithArrayAndReturn(m_arbitrary_conn_handle, p_local_db_data->data, p_local_db_data->len, p_local_db_data->len, BLE_GATTS_SYS_ATTR_FLAG_SYS_SRVCS, NRF_ERROR_INVALID_DATA);
    sd_ble_gatts_sys_attr_set_ExpectAndReturn(m_arbitrary_conn_handle, NULL, 0, (BLE_GATTS_SYS_ATTR_FLAG_SYS_SRVCS | BLE_GATTS_SYS_ATTR_FLAG_USR_SRVCS), NRF_SUCCESS);
    ...
    pdb_peer_data_ptr_get_ReturnThruPtr_p_peer_data(&returned_peer_data);
    sd_ble_gatts_sys_attr_set_ExpectWithArrayAndReturn(m_arbitrary_conn_handle, p_local_db_data->data, p_local_db_data->len,  p_local_db_data->len, p_local_db_data->flags, NRF_ERROR_INVALID_DATA);
    sd_ble_gatts_sys_attr_set_ExpectWithArrayAndReturn(m_arbitrary_conn_handle, p_local_db_data->data, p_local_db_data->len, p_local_db_data->len, BLE_GATTS_SYS_ATTR_FLAG_SYS_SRVCS, NRF_SUCCESS);
    ...
    pdb_peer_data_ptr_get_IgnoreArg_p_peer_data();
    pdb_peer_data_ptr_get_ReturnThruPtr_p_peer_data(&returned_peer_data);
    sd_ble_gatts_sys_attr_set_ExpectWithArrayAndReturn(m_arbitrary_conn_handle, p_local_db_data->data, p_local_db_data->len,  p_local_db_data->len, p_local_db_data->flags, NRF_SUCCESS);
    ...
    // No peer ID.
    im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle, PM_PEER_ID_INVALID);
    sd_ble_gatts_sys_attr_set_ExpectAndReturn(m_arbitrary_conn_handle, NULL, 0, SYS_ATTR_BOTH, NRF_SUCCESS);
...
ret_code_t pds_peer_data_store_stub(pm_peer_id_t                 peer_id,
...
void test_gscm_local_database_has_changed1(void)
{
    ...
    // STORAGE_FULL
    pds_next_peer_id_get_ExpectAndReturn(PM_PEER_ID_INVALID, m_arbitrary_peer_id);
    pds_peer_data_store_ExpectAndReturn(m_arbitrary_peer_id, NULL, NULL, NRF_ERROR_STORAGE_FULL);
    pds_peer_data_store_IgnoreArg_p_peer_data();
    pds_peer_data_store_IgnoreArg_p_store_token();
    ...
    TEST_ASSERT_EQUAL_UINT(NRF_ERROR_INTERNAL, m_evt_handler_records[0].params.error_unexpected.error);
    evt_handler_call_record_clear();
}
...
void test_gscm_service_changed_ind_needed(void)
{
    ...
    // No peer ID.
    im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle, PM_PEER_ID_INVALID);
    pdb_peer_data_ptr_get_ExpectAndReturn(PM_PEER_ID_INVALID, PM_PEER_DATA_ID_SERVICE_CHANGED_PENDING, &returned_peer_data, NRF_ERROR_INVALID_PARAM);
    pdb_peer_data_ptr_get_IgnoreArg_p_peer_data();
    ...
    // No data.
    im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle, m_arbitrary_peer_id);
    pdb_peer_data_ptr_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_SERVICE_CHANGED_PENDING, &returned_peer_data, NRF_ERROR_NOT_FOUND);
    pdb_peer_data_ptr_get_IgnoreArg_p_peer_data();
    ...
    // Success true
    im_peer_id_get_by_conn_handle_ExpectAndReturn(m_arbitrary_conn_handle, m_arbitrary_peer_id);
    pdb_peer_data_ptr_get_ExpectAndReturn(m_arbitrary_peer_id, PM_PEER_DATA_ID_SERVICE_CHANGED_PENDING, &returned_peer_data, NRF_SUCCESS);
    pdb_peer_data_ptr_get_IgnoreArg_p_peer_data();
    pdb_peer_data_ptr_get_ReturnThruPtr_p_peer_data(&returned_peer_data);
...
void test_gscm_service_changed_ind_send(void)
{
    ...
    sd_ble_gatts_initial_user_handle_get_IgnoreArg_p_handle();
    sd_ble_gatts_service_changed_ExpectAndReturn(BLE_CONN_HANDLE_INVALID, 0x0000, 0xFFFF, BLE_ERROR_INVALID_CONN_HANDLE);
    ...
    // Attempt 1.
    sd_ble_gatts_service_changed_ExpectAndReturn(m_arbitrary_conn_handle, 0x0000, 0xFFFF, BLE_ERROR_INVALID_ATTR_HANDLE);

    // Attempt 2.
    sd_ble_gatts_service_changed_ExpectAndReturn(m_arbitrary_conn_handle, 0x0001, 0xFFFF, BLE_ERROR_INVALID_ATTR_HANDLE);

    // Attempt 3.
    sd_ble_gatts_service_changed_ExpectAndReturn(m_arbitrary_conn_handle, 0x0002, 0xFFFF, BLE_ERROR_INVALID_ATTR_HANDLE);

    // Attempt 4: Success.
    sd_ble_gatts_service_changed_ExpectAndReturn(m_arbitrary_conn_handle, 0x0003, 0xFFFF, NRF_SUCCESS);
    ...
    sd_ble_gatts_initial_user_handle_get_ExpectAndReturn(NULL, NRF_SUCCESS);
    sd_ble_gatts_initial_user_handle_get_IgnoreArg_p_handle();
    sd_ble_gatts_service_changed_ExpectAndReturn(m_arbitrary_conn_handle, 0x0000, 0xFFFF, NRF_ERROR_BUSY);
    ...
    sd_ble_gatts_initial_user_handle_get_ExpectAndReturn(NULL, NRF_SUCCESS);
    sd_ble_gatts_initial_user_handle_get_IgnoreArg_p_handle();
    sd_ble_gatts_service_changed_ExpectAndReturn(m_arbitrary_conn_handle, 0x0000, 0xFFFF, BLE_ERROR_GATTS_SYS_ATTR_MISSING);
    sd_ble_gatts_service_changed_IgnoreArg_start_handle();
    ...
    sd_ble_gatts_initial_user_handle_get_ExpectAndReturn(NULL, NRF_SUCCESS);
    sd_ble_gatts_initial_user_handle_get_IgnoreArg_p_handle();
    sd_ble_gatts_service_changed_ExpectAndReturn(m_arbitrary_conn_handle, 0x0000, 0xFFFF, NRF_ERROR_INVALID_STATE);
    sd_ble_gatts_service_changed_IgnoreArg_start_handle();
    ...
    sd_ble_gatts_initial_user_handle_get_ExpectAndReturn(NULL, NRF_SUCCESS);
    sd_ble_gatts_initial_user_handle_get_IgnoreArg_p_handle();
    sd_ble_gatts_service_changed_ExpectAndReturn(m_arbitrary_conn_handle, 0x0000, 0xFFFF, NRF_ERROR_NOT_SUPPORTED);
    sd_ble_gatts_service_changed_IgnoreArg_start_handle();
    ...
    sd_ble_gatts_initial_user_handle_get_ExpectAndReturn(NULL, NRF_SUCCESS);
    sd_ble_gatts_initial_user_handle_get_IgnoreArg_p_handle();
    sd_ble_gatts_service_changed_ExpectAndReturn(m_arbitrary_conn_handle, 0x0000, 0xFFFF, NRF_SUCCESS);
    sd_ble_gatts_service_changed_IgnoreArg_start_handle();
