...
uint32_t stub_sd_ble_gatts_service_add_success(
	uint8_t type, ble_uuid_t const* p_uuid, uint16_t* p_handle, int cmock_num_calls)
{
...
static uint32_t stub_sd_ble_gatts_descriptor_add_success(
	uint16_t char_handle, const ble_gatts_attr_t *p_attr, uint16_t *p_handle, int calls)
{
...
static uint32_t stub_sd_ble_gatts_hvx_param_check(
	uint16_t conn_handle, ble_gatts_hvx_params_t const *p_hvx_params, int num_calls)
{
...
static uint32_t stub_sd_ble_gatts_hvx_success(
