...
function(bm_install_tasks output_hex output_bin)
  ...
  dt_nodelabel(slot0_path NODELABEL slot0_partition REQUIRED TARGET ${DEFAULT_IMAGE})
  dt_reg_size(slot0_size PATH "${slot0_path}" TARGET ${DEFAULT_IMAGE})
...
#  sysbuild_get(CONFIG_MCUBOOT_HARDWARE_DOWNGRADE_PREVENTION IMAGE ${DEFAULT_IMAGE} VAR CONFIG_MCUBOOT_HARDWARE_DOWNGRADE_PREVENTION KCONFIG)
  ...
  set(imgtool_sign ${PYTHON_EXECUTABLE} ${IMGTOOL} sign --version ${CONFIG_MCUBOOT_IMGTOOL_SIGN_VERSION} --align ${write_block_size} --slot-size ${slot0_size} --header-size ${CONFIG_ROM_START_OFFSET} --overwrite-only --custom-tlv 0xa0 0x01)
